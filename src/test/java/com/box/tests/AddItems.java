...
public class AddItems {
	...
	String moduleName = "Add New Photo";
	...
	public void addingItems(String username, String password) throws Exception {
		...
		try {
			...
			try {
				...
				reports.writeIntoFile(driver, testCaseName,  "Validate Photo is present in Home Screen after photo upload", "Upload any Photo", "Photo is present Home Screen", reports.pass, "", comlib.getCurrentTime());
			}catch(Error e)
			{
				reports.writeIntoFile(driver, testCaseName,  "Validate Photo is present in Home Screen after photo upload", "Upload any Photo", "Photo is not present Home Screen", reports.fail, e.getMessage(), comlib.getCurrentTime());
				System.out.println("Register button validation failed. Reason:" +e.getMessage());
				Assert.fail();
			}
